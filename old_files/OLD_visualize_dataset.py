...
DATASET_DIR = os.path.join(DATA_DIR, "processed_dataset_all")
...
SUBTILE_SIF_MODEL_FILE = os.path.join(DATA_DIR, "models/1d_train_tropomi_subtile_resnet_no_dimred") # "models/AUG_subtile_simple_cnn_v5")
