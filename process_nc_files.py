...
# TODO How to do this still in xarray?
data_array = dataset.dcSIF.sel(time=pd.date_range(start=START_DATE, end=END_DATE)).mean(dim='time')
...
print("Value at 100W, 45N:", data_array.sel(lat=-89.9, lon=-100.1))
