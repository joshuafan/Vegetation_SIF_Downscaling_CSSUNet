...
RESULTS_DIR = os.path.join(os.path.dirname(args.model_path), "final_results")  # + "_BEST_VAL_COARSE"
...
COLUMN_NAMES = ['true_sif', 'predicted_sif_linear', 'predicted_sif_mlp', 'predicted_sif_unet',
                    ...
                    'ref_1', 'ref_2', 'ref_3', 'ref_4', 'ref_5', 'ref_6', 'ref_7', # 'ref_10', 'ref_11',
    ...
    for sample in dataloader:
        with torch.set_grad_enabled(False):
            ...
            for i in range(input_tiles_std.shape[0]):
                ...
                # Plot selected tiles
                if args.plot_examples and sample['fraction_valid'][i] > 0.7:
                    print('Plotting')
                    # Plot example tile
                    ...
                    prediction_methods = ['Ridge', 'ANN', 'CS-SU-Net']
                    average_sifs = []
