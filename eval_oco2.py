...
TRAINED_MODEL_FILE = os.path.join(DATA_DIR, "models/AUG_subtile_simple_cnn_16crop_gaussian_noise")
...
METHOD = '4a_subtile_simple_cnn_small_gaussian_noise'  #'3_small_tile_simple' # '2_large_tile_resnet18'
