...
SIF_TILE_COLUMNS = IMAGE_COLUMNS + ['SIF', 'tropomi_cloud_fraction', 'num_soundings', 'surrounding_image_file']
...
DATE_RANGES = [pd.date_range(start="2018-07-22", end="2018-08-04"),
                    ...
                    with rio.open(os.path.join(REFLECTANCE_DIR, reflectance_file)) as reflectance_dataset:
                        ...
                        for image_top in image_tops:
                            for image_left in image_lefts:
                                ...
                                print('Combined area shape', combined_image.shape)
                                ...
                                # ===================== NOTE old code that only generates 0.1 degree tiles ============================
